  ...
  themeConfig:
    ...
    ({
      navbar: {
        title: 'Base de conhecimento do Fred',
        logo: {
          alt: 'Logo da base de conhecimento do Fred',
          src: 'img/logo.svg',
        },
        items: [
          {
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'GitHub',
                href: 'https://github.com/FredDietrich',
              },
              {
                label: 'LinkedIn',
                href: 'https://www.linkedin.com/in/frederico-dietrich-729056120/',
              }
            ],
          },
          // {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Frederico Dietrich. Built with Docusaurus.`,
      },
      prism: {
